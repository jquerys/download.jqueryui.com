var Builder, categories, glob, orderedComponents,
	...
	JqueryUiManifests_1_11_0 = require( "./jquery-ui-manifests-1-11.js" ),
	JqueryUiManifests_1_12_0 = require( "./jquery-ui-manifests-1-12.js" ),
...
function JqueryUi( path, options ) {
	...
	if ( semver.gte( jqueryUi.pkg.version, "1.12.0-a" ) ) {
		JqueryUiManifests_1_12_0.apply( this, arguments );
	} else {
		JqueryUiManifests_1_11_0.apply( this, arguments );
	}
}
